...
The following tutorials present Qubes OS by practicing basic skills. The tutorials should be followed in order. You will do simple things like connecting to a Wi-Fi hotspot. By doing that, you will be told about how Qubes OS works.

.. hint::

   **If you already know the system** and just want to check how to accomplish something, see the :ref:`index:How-to guides` instead.
